                    ...
                    <div class="row row-cols-1 person-post-content">
                        ...
                        <div class="col-md-5 person-post-content-post">
                            <div class="person-post-header">
                                ...
                                <?php if ($mypost) : ?>
                                    <div class="header-content-mypost">
                                        <div>
                                            <a href="/add/edit/?p=<?php echo $postinfo["post"] ?>" class="link" title="Редактировать пост">
                                                Редактировать
                                            </a>
                                        </div>
                                        <div>
                                            <a href="/add/delete/?p=<?php echo $postinfo["post"] ?>" class="link" title="Удалить пост">
                                                Удалить
                                            </a>
                                        </div>
                                    </div>
