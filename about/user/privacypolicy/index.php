...
<body>
    ...
    <p>
        ...
        информации, которую Оператор может получить о посетителях веб-сайта https://social.creagoo.ru.
    </p>
    <h3>
    ...
    <p>
        ...
        обеспечивающих их доступность в сети интернет по сетевому адресу https://social.creagoo.ru.
    </p>
    <p>
    ...
    <p>
        ...
        Пользователю веб-сайта https://social.creagoo.ru.
    </p>
    <p>
    ...
    <p>
        2.10. Пользователь – любой посетитель веб-сайта https://social.creagoo.ru.
    </p>
    <p>
    ...
    <p>
        ...
        Пользователем
        самостоятельно через специальные формы, расположенные на сайте https://social.creagoo.ru или направленные Оператору
