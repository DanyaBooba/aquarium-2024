...
<body class="container">
    <main class="col-md-8 mx-auto" style="margin-bottom: 50px" id="main">
        ...
        <div style="margin-bottom: 30px">
            ...
            <div class="p-4 mb-3" style="background-color: var(--bg-light); border-radius: 8px;">
                <p class="fs-4 mb-0">
                    «У меня остались только положительные эмоции: дизайн приятный, глаза не режет. Можно кастомизировать профиль,
                    добавляются новые возможности по кастомизации. Мне понравилась возможность выбрать собственную
                    аватарку, не загружая изображение...»
                </p>
            </div>
            <p class="text-more mb-0">
                Илья, 19 лет.
