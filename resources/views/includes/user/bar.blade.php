...
<div class="social">
    <div class="social-left">
        ...
        <div>
            <a href="{{ route('main') }}" title="{{ __('На главную') }}">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 22H19C19.5304 22 20.0391 21.7893 20.4142 21.4142C20.7893 21.0391 21 20.5304 21 20V9L12 2L3 9V20C3 20.5304 3.21071 21.0391 3.58579 21.4142C3.96086 21.7893 4.46957 22 5 22H9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 22V12H15V22" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </a>
        </div>
    </div>
    <div class="social-right">
        ...
        <div>
            <a href="{{ route('user.search') }}" class="{{ header_route_active_link('user.search') }}" title="{{ __('Поиск') }}">
...
@if(user_login())
    ...
    <li>
        <a href="{{ route('user.trends') }}" class="{{ header_route_active_link('user.trends') }}">
