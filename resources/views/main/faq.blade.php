...
@section('main.content')
    <div class="row gx-3">
        ...
        <div class="col-7 p-3">
            ...
            <p>
                {!! __('Целевая аудитория социальной сети: подростки и молодёжь, мальчики и девочки от <nobr>13-ти</nobr> лет и мужчины и девушки до 42 лет. Ограничений в использовании соцсети для других возрастов наблюдаться не будет, кроме детей до 13-ти лет.') !!}
            </p>
            <p>
                {{ __('Детям до 13-ти лет нужно получить согласие от родителей на обработку персональных данных. Заполнить форму можно по ссылке:') }} <a href="#">{{ __('Форма для детей до 13-ти лет') }}</a>.
            </p>
            <p>
